...
class Session:
    ...
    manifest: Manifest
    thermal_frames: Optional[np.ndarray]     # (N, 24, 32) or None
...
def replay_rules(radar_df: pd.DataFrame, clock: Optional[SessionClock] = None
                 ) -> List[Detection]:
...
def replay_ml(radar_df: pd.DataFrame, model_path: str,
              ...
              clock: Optional[SessionClock] = None) -> List[Detection]:
