...
from saferoom.ml.features import SEQ_FEATURE_COLS, extract_features_from_window
...
def _load_model(path: str):
    ...
    if ext == '.pkl':
        try:
            ...
            raise ImportError('joblib is required for .pkl models: pip install joblib') from err
        ...
        try:
            ...
            raise ImportError('torch is required for .pt models: pip install torch') from err
